...
%% LANGUAGE SETTINGS
% Sprache ggf. anpassen
% 
%\usepackage[ngerman]{babel} 	        % german language
%\usepackage[german=quotes]{csquotes} 	% correct quoting using \enquote{}
\usepackage[german]{babel}          % english language
...
%
\input{sections/form/nondisclosurenotice} 
\cleardoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\input{sections/form/acknowledge}
\cleardoublepage 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% Einleitung
\input{sections/content/einleitung.tex}

% mehrere Grundlagen- und Forschungs-Kapitel
\input{sections/content/kapitel1.tex}
\input{sections/content/kapitel2.tex}

% Fazit und Ausblick
\input{sections/content/zusammenfassung.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\initializeAppendix
\input{sections/form/appendix1}
\input{sections/form/appendix2}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
